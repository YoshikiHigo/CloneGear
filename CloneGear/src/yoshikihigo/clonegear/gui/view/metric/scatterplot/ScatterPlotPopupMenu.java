...
public class ScatterPlotPopupMenu extends JPopupMenu {
	...
	public ScatterPlotPopupMenu(final ScatterPlotPanel parentContainer) {
		...
		this.groupSeparetorMenuItem = new JCheckBoxMenuItem("Group Separator",
				true);
		this.coordinateLineMenuItem = new JCheckBoxMenuItem("Coordinate Line",
				true);
		...
		this.lastPositionSortMenuItem = new JRadioButtonMenuItem(
				"position of last code fragment", false);
		...
		this.groupSeparetorMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.fileSeparetorMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.coordinateLineMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.squareMenuItem.addActionListener(e -> parentContainer.repaint());
		this.rectangleMenuItem
				.addActionListener(e -> parentContainer.repaint());
		this.idSortMenuItem.addActionListener(e -> parentContainer.repaint());
		this.firstPositionSortMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.lastPositionSortMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.middlePositionSortMenuItem.addActionListener(e -> parentContainer
				.repaint());
		this.rangeSortMenuItem
				.addActionListener(e -> parentContainer.repaint());
		this.nifSortMenuItem.addActionListener(e -> parentContainer.repaint());
		this.imageMenuItem.addActionListener(e -> parentContainer
				.outputScatterPlotImage());
	}
