...
public class ScatterPlotPopupMenu extends JPopupMenu {
    ...
    public ScatterPlotPopupMenu(final ScatterPlotPanel parentContainer, final List<Area> historyList) {
        ...
        this.zoomThisGroupMenuItem = new JMenuItem("This Group(not implemented)");
        ...
        this.numericalInformationMenuItem = new JCheckBoxMenuItem("Numerical Information", true);
        ...
        this.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
                ...
                for (java.util.Iterator<Area> historyIterator = historyList.iterator(); historyIterator
                        .hasNext();) {
                    Area area = historyIterator.next();
                    final int startIndex = area.getStartIndex();
                    final int interruptIndex = area.getInterruptIndex();
                    final int restartIndex = area.getRestartIndex();
                    final int endIndex = area.getEndIndex();
                    ...
                    if (interruptIndex == -1) {
                        ...
                        JMenuItem historyMenuItem = new JMenuItem(GUIFileLabelManager.SINGLETON
                                ...
                                + " --- " + GUIFileLabelManager.SINGLETON.getIDLabel(endElement));
                        ...
                        JMenuItem historyMenuItem = new JMenuItem(GUIFileLabelManager.SINGLETON
                                .getIDLabel(startElement)
                                + " -- "
                                + GUIFileLabelManager.SINGLETON.getIDLabel(interruptElement)
                                + " __ "
                                + GUIFileLabelManager.SINGLETON.getIDLabel(restartElement)
                                + " --- "
                                + GUIFileLabelManager.SINGLETON.getIDLabel(endElement));
                        historyMenu.add(historyMenuItem);
                        historyMenuItem.addActionListener(new ActionListener() {
                            public void actionPerformed(ActionEvent e) {
                                parentContainer.zoomUp(startIndex, interruptIndex, restartIndex,
                                        endIndex);
                            }
                        });
                    }
        ...
        this.numericalInformationMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                parentContainer.repaint();
            }
        });
